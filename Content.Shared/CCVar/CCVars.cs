...
namespace Content.Shared.CCVar
{
    ...
    public sealed class CCVars : CVars
    {
        ...
        public static readonly CVarDef<float> SpaceWindPressureForceDivisorThrow =
            CVarDef.Create("atmos.space_wind_pressure_force_divisor_throw", 30f, CVar.SERVERONLY);

        /// <summary>
        ///     Divisor from maxForce (pressureDifference * 2.25f) to force applied on objects.
        /// </summary>
        public static readonly CVarDef<float> SpaceWindPressureForceDivisorPush =
            CVarDef.Create("atmos.space_wind_pressure_force_divisor_push", 3000f, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<float> SpaceWindMaxVelocity =
            CVarDef.Create("atmos.space_wind_max_velocity", 40f, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<float> CooldownAllMessage = CVarDef.Create("white.chat.cooldown_time_all_message", 0.5f, CVar.SERVERONLY);
        ...
        /// </summary>
        public static readonly CVarDef<float> CooldownLOOCMessage = CVarDef.Create("white.looc.cooldown_time", 90f, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<string> DefaultScreenChatSize =
            CVarDef.Create("ui.default_chat_size", "235x-475", CVar.CLIENTONLY | CVar.ARCHIVE);

        public static readonly CVarDef<string> SeparatedScreenChatSize =
            CVarDef.Create("ui.separated_chat_size", "0,6x0", CVar.CLIENTONLY | CVar.ARCHIVE);
        ...
        public static readonly CVarDef<string> InfoLinksAppeal =
            CVarDef.Create("infolinks.appeal", "https://discord.gg/2WAsvv5B5v", CVar.SERVER | CVar.REPLICATED);
     ...
     * TTS (Text-To-Speech)
        */
        ...
        public static readonly CVarDef<string> UtkaSocketKey =
            CVarDef.Create("utka.socket_key", "ass", CVar.SERVERONLY | CVar.CONFIDENTIAL);
