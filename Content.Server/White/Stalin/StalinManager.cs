...
public sealed class StalinManager
{
    ...
    public void Initialize()
    {
        ...
        _configurationManager.OnValueChanged(CCVars.StalinApiUrl, newValue => _stalinApiUrl = newValue, true);
        _configurationManager.OnValueChanged(CCVars.StalinAuthUrl, newValue => _stalinAuthUrl = newValue, true);
        _configurationManager.OnValueChanged(CCVars.StalinDiscordMinimumAge, newValue => _minimalDiscordAccountAge = newValue, true);
    }
    ...
    private string GenerateDiscordAuthUri(string ckey, string uid)
    {
        ...
        var saltBytes = Encoding.UTF8.GetBytes(_configurationManager.GetCVar(CCVars.StalinSalt));
