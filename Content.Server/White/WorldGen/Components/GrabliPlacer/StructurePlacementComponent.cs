...
namespace Content.Server.White.Worldgen.Components.GrabliPlacer;
...
public sealed class StructurePlacementComponent : Component
{
    ...
    /// </summary>
    [DataField("safetyRadius")] public int SafetyRadius = 426;

    [DataField("placementRadius")] public int PlacementRadius = 6128;
}
